...
DIRS=("lib" "bin/config" "bin/recursive_aggregation/fold" "bin/recursive_aggregation/c3_fold" "bin/recursive_aggregation/c3_fold_merge" "bin/recursive_aggregation/wrapper/dkg" "bin/recursive_aggregation/wrapper/threshold" "bin/dkg" "bin/threshold")
