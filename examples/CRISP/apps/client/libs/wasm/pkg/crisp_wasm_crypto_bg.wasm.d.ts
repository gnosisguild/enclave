...
export const closure281_externref_shim: (a: number, b: number, c: any, d: number, e: any) => void;
export const closure285_externref_shim: (a: number, b: number, c: any, d: any) => void;
