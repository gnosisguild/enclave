...
export const closure249_externref_shim: (a: number, b: number, c: any, d: number, e: any) => void;
export const closure253_externref_shim: (a: number, b: number, c: any, d: any) => void;
