...
export const closure335_externref_shim: (a: number, b: number, c: any) => void;
export const closure257_externref_shim: (a: number, b: number, c: any, d: number, e: any) => void;
export const closure261_externref_shim: (a: number, b: number, c: any, d: any) => void;
