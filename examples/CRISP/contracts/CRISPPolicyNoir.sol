...
/// @title CRISPPolicyNoir
/// @notice Policy contract for validating inputs based on Semaphore Noir proofs and usage limits.
contract CRISPPolicyNoir is BasePolicy {
    /// Errors
    ...
    /// @param evidence Abi-encoded `ISemaphore.SemaphoreNoirProof`.
    function _enforce(
        address subject,
    ...
    /// @notice Returns policy identifier "CRISPPolicyNoir".
    function trait() external pure returns (string memory) {
        return "CRISPPolicyNoir";
    }
}