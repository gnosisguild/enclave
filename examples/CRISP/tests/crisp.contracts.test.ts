...
describe("CRISP contracts", () => {
    ...
    describe("voting", async () => {
        ...
        it("should allow to vote", async () => {
            ...
            // register the member
            const registerTx = await crispProgramContract.registerMember(roundId, semaphoreIdentity.commitment)
            ...
            const tx = await enclaveContract.publishInput(roundId, encodedInputs)
