...
use e3_events::{
    ...
    DkgShareDecryptionProofRequest, DkgShareDecryptionProofResponse, InterfoldEvent,
    InterfoldEventData, EventPublisher, EventSubscriber, EventType, NodeDkgFoldRequest,
