...
use e3_encrypt::{bfv_encrypt_u64, bfv_verifiable_encrypt_u64};
...
pub fn bfv_encrypt_number(data: u64, public_key: Vec<u8>) -> Result<Vec<u8>, JsValue> {
    let encrypted_data =
...
pub fn bfv_verifiable_encrypt_number(
    ...
    let result = bfv_verifiable_encrypt_u64(data, public_key)
