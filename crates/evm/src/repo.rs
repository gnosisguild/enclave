...
pub trait EnclaveSolReaderRepositoryFactory {
    fn enclave_sol_reader(&self, chain_id: u64) -> Repository<EvmInterfaceState>;
}
...
pub trait CiphernodeRegistryReaderRepositoryFactory {
    fn ciphernode_registry_reader(&self, chain_id: u64) -> Repository<EvmInterfaceState>;
}
...
pub trait BondingRegistryReaderRepositoryFactory {
    fn bonding_registry_reader(&self, chain_id: u64) -> Repository<EvmInterfaceState>;
}
