...
export const THRESHOLD_BFV_PARAMS_PRESET_NAME = import.meta.env.VITE_THRESHOLD_BFV_PARAMS_PRESET_NAME || 'INSECURE_THRESHOLD_BFV_512'
...
const requiredEnvVars = {
  ...
  VITE_THRESHOLD_BFV_PARAMS_PRESET_NAME: THRESHOLD_BFV_PARAMS_PRESET_NAME,
}
