...
impl EnclaveRouter {
    pub fn new() -> Result<Self, Box<dyn Error>> {
        ...
        Ok(Self { identity: None, gossipsub_config, swarm: None })
    }
    ...
    pub fn connect_swarm(&mut self, discovery_type: String) -> Result<(), Box<dyn Error>> {
    	match discovery_type.as_str() {
    		...
    		_ => {
    			println!("Defaulting to MDNS discovery")
    		},
    	}
    	Ok(())
    }

    pub fn join_topic(topic: String) {
