...
> **Note on naming**
>
> The Interfold was previously known as **Interfold**.  
> Some repositories, package names, and CLI commands may still use `interfold` while the transition is
> in progress.
>
...
[Cryptography](/cryptography). To compile and lint the Noir workspace, run `interfold noir`, and wire
the prover from Rust, see [Noir Circuits](/noir-circuits).
