...
anyone to submit zero votes to mask slot activity and prevent receipt-sharing attacks.
...
The SDK also supports mask votes, generating proofs for zero-value votes that help prevent
receipt-sharing attacks. Before submission, proofs are verified locally to prevent failed
