...
├── interfold.config.yaml      # Ciphernodes + aggregator config
...
The [server](https://github.com/gnosisguild/interfold/tree/main/examples/CRISP/server) is a Rust-based
...
The [FHE program](https://github.com/gnosisguild/interfold/tree/main/examples/CRISP/program) is a Rust
...
The [CRISP SDK](https://github.com/gnosisguild/interfold/tree/main/examples/CRISP/packages/crisp-sdk)
...
Want to learn more about CRISP? Read our blogposts:

- [vote masking](https://blog.theinterfold.com/vote-masking-receipt-freeness-secret-ballots/)
