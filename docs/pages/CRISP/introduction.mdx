...
CRISP demonstrates how E3 programs can be used for privacy-preserving applications, providing
a complete reference implementation for developers building with the Interfold.
