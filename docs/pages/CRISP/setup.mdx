...
This guide will walk you through the steps to set up and run CRISP locally. CRISP is a full reference 
implementation of an E3 Program, built with a modern architecture that includes smart contracts,
