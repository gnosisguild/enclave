...
| **BondingRegistry**      | Handles license bonds (INTF) and ticket balances (ITK)                         |
...
| **InterfoldToken**       | INTF token used for license bonding                                            |
| **InterfoldTicketToken** | Non-transferable ITK token representing ticket balances (backed by stablecoin) |
...
| InterfoldToken (INTF) | `0xbAb3220FD04a193a192F07879673597Cd695Cb03` | 10939866     |
...
| **Licensed**    | INTF bonded but not yet registered in the registry                                 |
...
| Requirement     | Details                                                                  |
| --------------- | ------------------------------------------------------------------------ |
| **INTF Tokens** | At least `100 INTF` for the license bond (check `licenseRequiredBond()`) |
