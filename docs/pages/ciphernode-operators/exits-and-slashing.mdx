...
- Keep the operator wallet funded; payouts are on-chain transfers and still require gas when claimed
...
Seeing rewards fall while balances remain healthy is an early indicator of missed jobs or RPC
issues.
