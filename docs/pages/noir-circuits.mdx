...
[`scripts/README.md`](https://github.com/gnosisguild/enclave/blob/main/scripts/README.md#circuit-builder)
and
[`circuits/benchmarks/README.md`](https://github.com/gnosisguild/enclave/blob/main/circuits/benchmarks/README.md).
