...
The Interfold ships a dedicated Noir workspace under `circuits/` plus reusable libraries (SAFE sponge API,
...
Each library has its own `README.md` describing APIs and dependency stanzas. Example (`safe`):
