...
polynomial utilities, modular arithmetic, PVSS circuit primitives, etc.). Use these circuits as-is
or vendor them into your own E3 programs.
...
│   │                           # decrypted_shares_aggregation_bn, decrypted_shares_aggregation_mod)
