---
title: 'Quick Start'
description: 'Get up and running with your first E3 program on The Interfold'
---

> **Rebrand Update**: Enclave is now **The Interfold**.  
> The CLI, packages, and many tool names still use `enclave` during the transition.  
> Documentation is being actively updated.

# Quick Start

Get your first E3 program running on **The Interfold** protocol!

This guide assumes you have the [Interfold CLI installed](../installation).
...
4. **Run real Ciphernodes**: Follow the [Ciphernode Operators guide](/ciphernode-operators) to bond
   tokens, configure nodes, and join the shared network
