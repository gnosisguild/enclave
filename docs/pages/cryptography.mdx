...
2. **Decryption recursive proof**: the aggregator recursively verifies **C6** proofs from at least
   **T+1** parties together with **C7**, which reconstructs the plaintext. Verified on-chain by
   [`BfvDecryptionVerifier`](https://github.com/gnosisguild/enclave/blob/main/packages/enclave-contracts/contracts/verifiers/bfv/BfvDecryptionVerifier.sol)
...
[**C2**](https://github.com/gnosisguild/enclave/tree/main/circuits/bin/dkg/sk_share_computation) is
