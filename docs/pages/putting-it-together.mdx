...
To solidify your understanding, let's walk through an example of building and deploying an E3
Program using RISC Zero.
...
import {IInterfold, IE3Program} from "@interfold/contracts/interfaces/IInterfold.sol";
...
await FeeTokenContract.approve(InterfoldContract.address, computationFee)

// Then request the E3
await InterfoldContract.request({
...
- **Interfold GitHub Repository**:
  [https://github.com/gnosisguild/interfold](https://github.com/gnosisguild/interfold)
- **CRISP GitHub Repository**:
  [https://github.com/gnosisguild/interfold](https://github.com/gnosisguild/interfold/tree/main/examples/CRISP)
