...
- **CRISP GitHub Repository**: [https://github.com/gnosisguild/crisp](https://github.com/gnosisguild/crisp)
- **Enclave Starter Template**: [https://github.com/gnosisguild/enclave-starter-template](https://github.com/gnosisguild/enclave-starter-template)
